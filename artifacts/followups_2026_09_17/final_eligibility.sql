...
SELECT COALESCE(json_agg(x),'[]') FROM (SELECT * FROM pool WHERE inbound_count=0 AND negative_count=0 AND pending_count=0 AND firm_latest<now()-interval '7 days' AND lower(email) IN ('ssoliman@thesolimanfirm.com','ethan@esqlegalgroup.com','estelaricheda@earthlink.net','daniel.kim@dklaw.com','dchoyce@choycelawfirm.com','svaziri@vazirilaw.com','rogerb@bonakdarlawfirm.com','daniel@setarehfirm.com','dcarter@carterlawgroup.com','reina@resnikpersonalinjury.com','silvia@silviaereynosolaw.com','richarda@ralawllp.com','acohen@actslaw.com','abraham@abginlaw.com','kfasoro@fasorolaw.com','robert@robertmontanezlaw.com','elliot@zarabilaw.com','jura@jhartleylawapc.com','edna@ednafelix.law','alla@teninalaw.com') ORDER BY latest DESC) x;
