...
function OperatorActionDrawer({
  ...
  return (
    <aside
      className="fixed bottom-0 right-0 top-0 z-[990] flex w-full max-w-[680px] flex-col border-l border-neutral-200 bg-white pb-[env(safe-area-inset-bottom)] shadow-2xl sm:w-[92vw] lg:w-[680px]"
